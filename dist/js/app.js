(() => {
    ...
    function tippyHma3dleMd2Change(e) {
        if (e.matches) modules_flsModules.tippy = tippy_esm("[data-tippy-content]", {});
    }
    ...
    function initSliders() {
        if (document.querySelector(".home__slider")) {
            ...
            let homeSlider = new core(".home__slider", {
                direction: "vertical",
                slidesPerView: "auto",
            ...
            if (sliderLinks.length > 0) sliderLinks.forEach((element => {
        ...
        if (document.querySelector(".template1__slider")) {
            ...
            function template1HandleMd2Change(e) {
                if (e.matches) new core(".template1__slider", {
                    modules: [ Lazy ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1.5,
    ...
    if (homeSlider) document.querySelector(".page").classList.add("_fixed");
    ...
    if (genders.length > 0) genders.forEach((element => {
        ...
        gendersRadio.forEach((radio => {
            radio.addEventListener("change", (function() {
                ...
                if (select) select.classList.remove("_disabled");
                ...
                if ("female" == this.value) gendersVariable = "first";
                if ("male" == this.value) {
                    parent.querySelector(".service_4").classList.add("_disabled");
    ...
    document.addEventListener("selectCallback", (function(e) {
        ...
        if (serviceItem) serviceItem.classList.remove("_disabled");
        if (serviceCombination) calculate(gendersVariable, birthVariable, serviceCombination, serviceCombinationText);
    }));
    const service = document.querySelectorAll(".options-service");
    if (service.length > 0) service.forEach((element => {
        ...
        serviceInput.forEach((input => {
            input.addEventListener("change", (function() {
                if (this.closest(".checkbox").classList.contains("service_2")) {
                    if (freude.checked) nutzen.checked = true;
                } else if (freude.checked) nutzen.checked = true;
                if (femaleInput.checked) {
                    if (sicherheit.checked || nutzen.checked) parent.querySelector(".service_4").classList.remove("_disabled"); else {
                        parent.querySelector(".service_4").classList.add("_disabled");
                        baby.checked = false;
                    }
                    if (baby.checked) sicherheit.checked = true;
                }
                ...
                if (sicherheit.checked || freude.checked || nutzen.checked || baby.checked) {
                    ...
                    if (total) total.classList.add("_active");
                    if (nextStepButton) if (femaleInput.checked || maleInput.checked || kindInput.checked) nextStepButton.classList.remove("_disabled");
                } else {
    ...
    if (formControls.length > 0) formControls.forEach((controls => {
        ...
        options.forEach((element => {
            ...
            controlsInput.forEach((input => {
                input.addEventListener("change", (function() {
                    ...
                    if ("whatsapp" == this.value || "phone" == this.value) contactInput.placeholder = "+43 660 0000 000"; else if ("email" == this.value) contactInput.placeholder = "email@gmx.at";
                }));
            }));
        }));
        ...
        function validate(radioValue) {
            let error = 0;
            if ("email" == radioValue) {
                if (!validateEmail(contactInput.value)) error++;
            } else if (!validatePhone(contactInput.value)) error++;
            if (0 == !error) {
                parent.querySelector(".form__submit").classList.add("_disabled");
