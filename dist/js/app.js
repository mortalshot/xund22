    ...
    if (genders.length > 0) genders.forEach((element => {
        ...
        gendersRadio.forEach((radio => {
            radio.addEventListener("change", (function() {
                ...
                if (serviceItems) serviceItems.forEach((item => {
    ...
    if (service.length > 0) service.forEach((element => {
        ...
        serviceInput.forEach((input => {
            input.addEventListener("change", (function() {
                ...
                if (sicherheit.checked || freude.checked || nutzen.checked || baby.checked) parent.querySelector(".form__item-wrapper").classList.remove("_disabled"); else {
